...
http-response ^http:\/\/duoting\.tatatimes\.com\/tataeraapi\/api\.s\ script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/englishread.js,requiers-body=true,tag=英语阅读
...
http-response https?:\/\/gw\.aoscdn\.com\/base\/vip\/client\/authorizations$ requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/apowersoft.js,tag=奥软抠图
http-response ^https?:\/\/appraven\.net\/AppRaven\/(app|social|buy) requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/appraven.js,tag=Appraven
http-response https?:\/\/screen-lock\.51wnl-cq\.com\/userApi\/saveUser requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/budingsuoping.js,tag=布丁锁屏
http-response ^https?:\/\/app\.bilibili\.com\/x\/v2\/account\/myinfo\? requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Script/bilibili_diy.js,tag=Bili 1080P
...
http-response ^https:\/\/claritywallpaper\.com\/clarity\/api\/(userInfo|special\/queryByCatalogAll) requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/clarity.js,tag=克拉壁纸
http-response https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user) requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/caiyun.js,tag=彩云天气pro
http-response https?:\/\/bookapi\.ellabook\.cn\/rest\/api\/service$ requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/elabook.js,tag=ellabook
...
http-response ^https?:\/\/user\.ftmailbox\.cn\/ios-receipt-validation\.php.* requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/ftchinese.js,tag=FT中文网
...
http-response https?:\/\/api\.risingfalling\.com\/api\/vip\/detail requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/qifu.js,tag=起伏
http-response ^https?:\/\/appraven\.net\/AppRaven\/(app|social|buy) requires-body=1,script-path=https://raw.githubusercontent.com/ddgksf2013/Cuttlefish/master/Crack/appraven.js，tag=Appraven
